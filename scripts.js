$(document).ready(() => {
    ...
    function quotes2() {
        let quoteSpace = document.getElementById("carouselSpace2");
        let active = "active";
        let inactive = "inactive";
        if (quoteSpace) {
            $.ajax({
                ...
                success: function (json) {
                    console.log(json);
                    json.forEach((element) => {
                        $("#carouselSpace2").append(`
                        <div id="carouselItem" class="carousel-item ${
                            element.id === 1 ? active : inactive
                        } text-white">
                            <div class="carousel-item-info d-flex">
                            <img class="d-block carousel__img mr-3" src="${element.pic_url}"
                                alt="First slide">
                            <div class="info pb-5">
                                <p type="quotetype" class="mt-4">${element.text}</p>
